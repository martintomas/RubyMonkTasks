...
# Hue difference is:
#  |R1 - R2| + |G1 - G2| + |B1 - B2| where |x| is the absolute value of x
# If Brightness difference is more than 125 and the
# Hue difference is more than 500 then the colors have sufficient contrast
